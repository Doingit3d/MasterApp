 ...
 * {@link MenuTiempoReal.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MenuTiempoReal#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenuTiempoReal extends Fragment {
     ...
     * @return A new instance of fragment MenuTiempoReal.
     */
    // TODO: Rename and change types and number of parameters
    public static MenuTiempoReal newInstance(String param1, String param2) {
        MenuTiempoReal fragment = new MenuTiempoReal();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_menu_tiempo_real, container, false);
...
// change speed to 140 Km/h
        ...
        speedometer.setOnPrintTickLabel(new OnPrintTickLabel() {
            ...
            public String getTickLabel(int tickPosition, int tick) {
                ...
                return String.format(Locale.getDefault(), "%d Kg", tick);
            }
        });
        //ArcProgressStackView.Model m = new ArcProgressStackView.Model("Silo 1", 25, Color.BLACK, Color.RED);
        //models.add(m);
       // m.setTitle("Silo 1");
